...
from go.utils import point_from_coords

__all__ = [
    'get_web_app',
]

html_files = {"random": "go/httpfrontend/static/playRandom_99.html",
              "akira": "httpfrontend/static/play_Akira.html"}
...
def get_web_app(bot_map):
    ...
    """
    if bot_map is None:
        html_file = "go/httpfrontend/static/playHuman.html"
    else:
        html_file = html_files[next(iter(bot_map.keys()))]
